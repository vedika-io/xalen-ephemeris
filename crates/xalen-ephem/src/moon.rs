...
// ---------------------------------------------------------------------------
// Full ELP2000-82 Moon (Meeus Ch.47, "Astronomical Algorithms" 2nd ed.)
//
// 60 longitude + distance terms  (Table 47.A, pp 339-340)
// 60 latitude terms              (Table 47.B, p 341)
// Accuracy: ~2 arcseconds in longitude (~10x improvement over 24-term set)
// ---------------------------------------------------------------------------
...
/// Compute the geocentric ecliptic position of the Moon using the full
/// Meeus Ch.47 truncated ELP2000-82 theory.
///
/// Returns ecliptic longitude & latitude (radians, J2000 ecliptic) and
/// distance in AU. Accuracy: ~2" in longitude, ~1" in latitude.
