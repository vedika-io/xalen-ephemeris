...
pub fn number_meaning(n: u32) -> &'static str {
    match n {
        ...
        3 => "Expression, creativity, joy, social interaction",
        4 => "Stability, discipline, hard work, foundation building",
        5 => "Freedom, change, adventure, versatility",
        6 => "Responsibility, nurturing, harmony, domestic life",
        7 => "Introspection, analysis, spirituality, wisdom",
        8 => "Power, abundance, achievement, material mastery",
        9 => "Humanitarianism, compassion, completion, universal love",
        11 => "Master Intuition — spiritual insight, inspiration, illumination",
        22 => "Master Builder — turning dreams into reality, large-scale achievement",
        33 => "Master Teacher — selfless service, spiritual upliftment, healing",
        _ => "Compound number — reduce further for core meaning",
    }
}
...
mod tests {
    ...
    fn number_meanings_all_single() {
        for i in 1..=9 {
            assert!(!number_meaning(i).is_empty());
        }
    }
